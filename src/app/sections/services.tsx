      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto mb-8">
            Our comprehensive AML compliance solution provides real-time
            screening against global sanctions databases, ensuring your business
          ...
          >
            <div className="bg-gray-50 dark:bg-gray-800 rounded-2xl p-8 shadow-lg border border-gray-200 dark:border-gray-700">
              ...
              <div className="space-y-3">
                {sanctionFeatures[activeFeatureIndex].features.map(
                  (feature, index) => (
                    <motion.div
                      key={index}
        ...
        >
          <div className="bg-gradient-to-r from-gray-900 to-gray-800 dark:from-gray-800 dark:to-gray-700 rounded-2xl p-12 text-white">
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-2xl mx-auto">
              ...
              regulatory standards with our advanced sanction screening
              capabilities.
            </p>
            <a
              href="#Contact"
